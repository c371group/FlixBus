...
private:
	...
	int rate_per_mile = 0; /* again, implicitly linked to type. While it's in decimal numbers, it's best to put it in integers (i.e. 0.16 per mile
...
public:
	...
	std::map<std::pair<int, char>, std::pair<int, double>> seats{ {{1,'A'},{0,windowSeatRate}}, {{1,'B'},{0, aisleSeatRate} }, {{ 1,'C' }, {0, aisleSeatRate}}, {{ 1,'D' }, {0, aisleSeatRate} }, {{ 1,'E' }, {0,windowSeatRate} },
		{{2,'A'},{0,windowSeatRate} }, {{2,'B'},{0, aisleSeatRate} }, {{ 2,'C' }, {0, aisleSeatRate}}, {{ 2,'D' }, {0, aisleSeatRate} }, {{ 2,'E' }, {0,windowSeatRate} },
		{{3,'A'},{0,windowSeatRate} }, {{3,'B'},{0, aisleSeatRate} }, {{ 3,'C' }, {0, aisleSeatRate}}, {{ 3,'D' }, {0, aisleSeatRate} }, {{ 3,'E' }, {0,windowSeatRate} },
		{{4,'A'},{0,windowSeatRate} }, {{4,'B'},{0, aisleSeatRate} }, {{ 4,'C' }, {0, aisleSeatRate}}, {{ 4,'D' }, {0, aisleSeatRate} }, {{ 4,'E' }, {0,windowSeatRate} },
		{{5,'A'},{0,windowSeatRate} }, {{5,'B'},{0, aisleSeatRate} }, {{ 5,'C' }, {0, aisleSeatRate}}, {{ 5,'D' }, {0, aisleSeatRate} }, {{ 5,'E' }, {0,windowSeatRate} },
		{{6,'A'},{0,windowSeatRate} }, {{6,'B'},{0, aisleSeatRate} }, {{ 6,'C' }, {0, aisleSeatRate}}, {{ 6,'D' }, {0, aisleSeatRate} }, {{ 6,'E' }, {0,windowSeatRate} },
		{{7,'A'},{0,windowSeatRate} }, {{7,'B'},{0, aisleSeatRate} }, {{ 7,'C' }, {0, aisleSeatRate}}, {{ 7,'D' }, {0, aisleSeatRate} }, {{ 7,'E' }, {0,windowSeatRate} },
		{{8,'A'},{0,windowSeatRate} }, {{8,'B'},{0, aisleSeatRate} }, {{ 8,'C' }, {0, aisleSeatRate}}, {{ 8,'D' }, {0, aisleSeatRate} }, {{ 8,'E' }, {0,windowSeatRate} },
		{{9,'A'},{0,windowSeatRate} }, {{9,'B'},{0, aisleSeatRate} }, {{ 9,'C' }, {0, aisleSeatRate}}, {{ 9,'D' }, {0, aisleSeatRate} }, {{ 9,'E' }, {0,windowSeatRate} },
		{{10,'A'},{0,windowSeatRate} }, {{10,'B'},{0, aisleSeatRate} }, {{ 10,'C' }, {0, aisleSeatRate}}, {{ 10,'D' }, {0, aisleSeatRate} }, {{ 10,'E' }, {0,windowSeatRate} },
...
public:
	// Seats map. <int, char> represents seats id(1A 1B 1C) the <int> will be either 0 or 1, representing if the seat is taken(1) or free(0).
	std::map<std::pair<int, char>, std::pair<int, double>> seats{ {{1,'A'},{0,windowSeatPrice} }, {{1,'B'},{0, aisleSeatPrice} }, {{ 1,'C' }, {0,windowSeatPrice}},
